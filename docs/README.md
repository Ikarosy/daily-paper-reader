...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-08 09:48:34 UTC<br>状态：成功</p>
</section>
...
<p>今日聚焦大模型量化，12篇论文中精读6篇，重点攻克混合精度与率失真理论。</p>
<p>最值得关注：Q-Strata提出MoE分层比特分配，统一率失真框架贯通向量、乘积与标量量化，双获高分。</p>
<p>普通读者可沿“量化损伤全局建模”与“低比特梯度空间微调”两条线索，顺藤摸瓜理解LLM压缩新趋势。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Q-Strata: Hierarchical Bit Allocation for Mixed-Precision Quantization of Mixture-of-Experts LLMs">Q-Strata: Hierarchical Bit Allocation for Mixed-Precision Quantization of Mixture-of-Experts LLMs</span></li><li><span class="dpr-home-dashboard-paper-title" title="A Unified Rate-Distortion Perspective on Vector, Product, and Scalar Quantization">A Unified Rate-Distortion Perspective on Vector, Product, and Scalar Quantization</span></li><li><span class="dpr-home-dashboard-paper-title" title="RSLM: Training-Free Vector Quantization for Approximate Nearest Neighbor Search">RSLM: Training-Free Vector Quantization for Approximate Nearest Neighbor Search</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Fine-Tuning Low-Bit Models with Gradient in Quantized Code Space">Fine-Tuning Low-Bit Models with Gradient in Quantized Code Space</span></li><li><span class="dpr-home-dashboard-paper-title" title="The Structure of Quantization Damage in LLMs: Why the Next Bit Should Be Spent Globally">The Structure of Quantization Damage in LLMs: Why the Next Bit Should Be Spent Globally</span></li><li><span class="dpr-home-dashboard-paper-title" title="SCULPT: Training Edge Vision Models for Post-Training Quantization Readiness">SCULPT: Training Edge Vision Models for Post-Training Quantization Readiness</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">wbv <strong>5</strong></span><span class="dpr-home-dashboard-tag">moe-quant <strong>1</strong></span></div>
</section>
</div>

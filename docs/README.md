...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-07 23:15:01 UTC<br>状态：成功</p>
</section>
...
<p>今日精读两篇、速读一篇，聚焦大模型与微控制器的量化压缩新方案；最值得关注的是《HBQ》以硬件感知分层缩放量化实现高精度LLM推理，评分9.0，而《Deep Microcompression》针对MCU的结构化剪枝与位打包量化也达8.0分。建议普通读者优先了解HBQ在硬件效率与精度间的平衡思路，并留意其后续落地部署案例。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="HBQ: Hierarchical Scaling Block Quantization with Hardware-Efficiency-Aware Design for Accurate LLM Inference">HBQ: Hierarchical Scaling Block Quantization with Hardware-Efficiency-Aware Design for Accurate LLM Inference</span></li><li><span class="dpr-home-dashboard-paper-title" title="Deep Microcompression: Structured Pruning and Bit-packed Quantization for Microcontrollers">Deep Microcompression: Structured Pruning and Bit-packed Quantization for Microcontrollers</span></li></ul>
  </div>

...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-08 22:53:04 UTC<br>状态：成功</p>
</section>
...
<p>今日精读两篇高分论文：字节跳动统一AI搜索引擎ByteX，以及面向高效LLM推理的分层块量化HBQ。最值得关注的是ByteX如何整合搜索与生成，以及HBQ在硬件效率与精度间的平衡。建议普通读者优先浏览ByteX的设计思路，了解新一代AI搜索形态。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="ByteX: A Unified AI Search Engine at ByteDance">ByteX: A Unified AI Search Engine at ByteDance</span></li><li><span class="dpr-home-dashboard-paper-title" title="HBQ: Hierarchical Scaling Block Quantization with Hardware-Efficiency-Aware Design for Accurate LLM Inference">HBQ: Hierarchical Scaling Block Quantization with Hardware-Efficiency-Aware Design for Accurate LLM Inference</span></li><li><span class="dpr-home-dashboard-paper-title" title="FlexPosit: Tunable Fractional Precision for LLM Inference Accelerators">FlexPosit: Tunable Fractional Precision for LLM Inference Accelerators</span></li></ul>
  </div>
